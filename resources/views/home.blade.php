...
<body class="bg-background text-on-background selection:bg-primary-container selection:text-on-primary-container font-body-md">
    <!-- Header / TopNavBar -->
    <header class="fixed top-0 left-0 w-full z-50 bg-surface border-b border-outline-variant">
        <nav class="flex justify-between items-center px-gutter py-4 w-full max-w-container-max mx-auto">
            <a href="/" class="text-headline-md font-headline-lg text-primary tracking-tight font-bold">Peta Warga Gandekan</a>
            ...
            <div class="flex items-center gap-3">
                @auth
                    <a href="{{ url('/dashboard') }}" class="bg-primary text-on-primary px-6 py-2.5 rounded-lg font-label-md hover:bg-primary-container hover:text-on-primary-container active:scale-95 transition-all">
                        Dashboard Admin
                    </a>
                @else
                    <a href="{{ url('/peta') }}" class="bg-primary text-on-primary px-6 py-2.5 rounded-lg font-label-md hover:bg-primary-container hover:text-on-primary-container active:scale-95 transition-all">
                        Buka Peta Sekarang
                    </a>
                @endauth
            </div>
    ...
    <main class="pt-20">
        ...
        <section class="relative min-h-[800px] flex items-center overflow-hidden hero-gradient">
            <div class="max-w-container-max mx-auto px-gutter w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-stack-lg">
                <div class="space-y-stack-md z-10">
                    ...
                    <div class="flex flex-wrap gap-4 pt-4">
                        <a href="{{ url('/peta') }}" class="bg-primary text-on-primary px-8 py-4 rounded-xl font-headline-md flex items-center gap-3 shadow-lg shadow-primary/20 hover:-translate-y-0.5 transition-transform">
                            Buka Peta Interaktif
                            <span class="material-symbols-outlined">map</span>
                        </a>
                        <a href="#features" class="bg-surface-bright text-primary border border-primary/20 px-8 py-4 rounded-xl font-headline-md hover:bg-surface-container transition-colors">
                ...
                <div class="relative">
                    <div class="aspect-[4/3] md:aspect-square bg-white rounded-3xl shadow-2xl overflow-hidden border border-outline-variant p-2 transform rotate-1 hover:rotate-0 transition-transform duration-500">
                        <div class="w-full h-full rounded-2xl bg-surface-container-lowest overflow-hidden relative" id="preview-map-container">
                            <div id="homepage-map" class="w-full h-full min-h-[350px]"></div>
                        </div>
                    </div>
                    <!-- Floating Stats Card -->
            ...
            <div class="max-w-container-max mx-auto px-gutter">
                <div class="flex flex-col md:flex-row gap-16 items-center">
                    <div class="w-full md:w-1/2">
                        <div class="bg-surface-container-lowest p-8 rounded-2xl shadow-lg border border-outline-variant space-y-6">
                            <div class="flex items-center gap-4 border-b border-outline-variant pb-4">
                                ...
                                <div>
                                    <h3 class="font-headline-md text-on-background">Peta Wilayah Gandekan</h3>
                                    <p class="text-label-md text-on-surface-variant">Sistem Informasi Geografis Warga</p>
                                </div>
                            </div>
                            <div class="space-y-4">
                                <div class="p-4 bg-surface-container-low rounded-lg border border-outline-variant flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-body-md text-on-surface">Pencarian Nama & Alamat</span>
                                    </div>
                                ...
                                <div class="p-4 bg-surface-container-low rounded-lg border border-outline-variant flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-body-md text-on-surface">Pinpoint Koordinat Presisi</span>
                                    </div>
                                    <span class="px-2 py-1 bg-secondary-container text-on-secondary-container text-label-sm rounded">Aktif</span>
                                </div>
                                <div class="p-4 bg-surface-container-low rounded-lg border border-outline-variant flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-body-md text-on-surface">Rute Direct Google Maps</span>
                                    </div>
                                    <span class="px-2 py-1 bg-secondary-container text-on-secondary-container text-label-sm rounded">Aktif</span>
                                </div>
                            </div>
        ...
        <section class="py-section-gap-lg px-gutter">
            <div class="max-w-container-max mx-auto bg-inverse-surface rounded-[40px] overflow-hidden relative p-12 md:p-24 text-center">
                <div class="relative z-10 max-w-3xl mx-auto space-y-stack-md">
                    ...
                    <div class="pt-8">
                        <a href="{{ url('/peta') }}" class="inline-block bg-secondary-container text-on-secondary-container px-12 py-5 rounded-full font-headline-md text-lg hover:scale-105 active:scale-95 transition-all shadow-xl shadow-secondary/20">
