...
<head>
    ...
    <title>Edit Data — Rumah Kita Gandekan</title>
        ...
        <div class="max-w-2xl mx-auto">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi rumah warga</p>
                </div>
            </div>
                ...
                <form action="{{ route('admin.update', $warga) }}" method="POST">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="nama_pemilik" id="nama_pemilik" value="{{ old('nama_pemilik', $warga->nama_pemilik) }}" required class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl text-sm bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                        ...
                        <div>
                            ...
                            <textarea name="alamat" id="alamat" rows="2" required class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl text-sm bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">{{ old('alamat', $warga->alamat) }}</textarea>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" step="any" name="latitude" id="latitude" value="{{ old('latitude', $warga->latitude) }}" required class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl text-sm bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition font-mono">
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="longitude" id="longitude" value="{{ old('longitude', $warga->longitude) }}" required class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl text-sm bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition font-mono">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">Drag marker untuk mengubah posisi, atau klik lokasi baru</p>
                    ...
                    <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-800">
                        ...
                        <button type="submit" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-xl shadow-lg shadow-blue-600/25 transition-all hover:-translate-y-0.5">Simpan Perubahan</button>
                    </div>
                </form>
            </div>
        </div>
